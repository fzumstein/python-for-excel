...
# Read in all files: since we are using the files from the 
# folder of Chapter 5, we need to adjust the path slightly
parts = []
for path in (this_dir.parent / 'ch05' / 'sales_data').rglob('*.xls*'):
